...
<div class="wrap">
    ...
    <form method="post" id="snippet-form" action="" style="margin-top: 10px;"
                ...
                <div class="editor-help-text">
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <kbd class="pc-key"><?php echo $keys['Ctrl']; ?></kbd><kbd
                                        class="mac-key"><?php echo $keys['Cmd']; ?></kbd>&hyphen;<kbd><?php echo $keys['G']; ?></kbd>
                            </td>
                        </tr>
                        <tr>
                            <td><?php esc_html_e('Find previous', 'code-snippets'); ?></td>
                            <td>
                                <kbd><?php echo $keys['Shift']; ?></kbd>-<kbd
                                        class="pc-key"><?php echo $keys['Ctrl']; ?></kbd><kbd
                                        class="mac-key"><?php echo $keys['Cmd']; ?></kbd>&hyphen;<kbd><?php echo $keys['G']; ?></kbd>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <kbd><?php echo $keys['Shift']; ?></kbd>&hyphen;<kbd
                                        class="pc-key"><?php echo $keys['Ctrl']; ?></kbd><kbd
                                        class="mac-key"><?php echo $keys['Cmd']; ?></kbd>&hyphen;<kbd><?php echo $keys['F']; ?></kbd>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <kbd><?php echo $keys['Shift']; ?></kbd>&hyphen;<kbd
                                        class="pc-key"><?php echo $keys['Ctrl']; ?></kbd><kbd
                                        class="mac-key"><?php echo $keys['Cmd']; ?></kbd><span
                                        class="mac-key">&hyphen;</span><kbd
                                        class="mac-key"><?php echo $keys['Option']; ?></kbd>&hyphen;<kbd><?php echo $keys['R']; ?></kbd>
                            </td>
                        </tr>
                        <tr>
        ...
        <div id="snippet_values_wrapper" style="margin:10px">
            <?php
        ...
        <input type="hidden" id="snippet_is_template"
               name="snippet_is_template" <?php if ($snippet->is_template): ?> value="is_template" <?php endif; ?> >
        <button type="button" id="advanced_view_wpd" class="button button-primary" editor_section>Advanced view</button>
        <div id="snippet_advanced_view" style="display:none">
            ...
            <?php endif; ?>
            <br/>
            <h1>Snippet execution</h1>
            <div id="snippet_execute_div" class="editor_section">
                <button type="button" id="run_code_wpd" class="button button-primary editor_section">Run code</button>
                <br/>
                <div id="snippet_output" contenteditable style="margin: 5px"></div>
            </div>
            <h1>Snippet settings</h1>
            <div id="snippet_setting_div" class="editor_section">

                <div id="snippet_settings_wrapper" style="display:none; margin:10px">
                    <?php foreach ($snip_settings as $key => $setting):
                        ...
                        <div id="snippet_setting_<?= $key ?>">
                            ...
                            <div class="editor_section">
                                <label>Value:</label>
                                <input type="text" class="setting_value" value="<?= $snip_values[$setting['replace']] ?>"><br>
                            </div>
                        </div>
                    <?php endforeach; ?>
                </div>
                <div id="snippet_setting_buttons" style="display:none">
