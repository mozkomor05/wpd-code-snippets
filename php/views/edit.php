        ...
        <div class="snippet-editor">
            ...
            <div class="snippet-editor-help">
				...
				$keys = array(
					...
					'Z'      => esc_html_x( 'Z', 'keyboard key', 'code-snippets' ),
					'Y'      => esc_html_x( 'Y', 'keyboard key', 'code-snippets' ),
					'H'      => esc_html_x( 'H', 'keyboard key', 'code-snippets' ),
					'U'      => esc_html_x( 'U', 'keyboard key', 'code-snippets' ),
				);
                ...
                <div class="editor-help-text">
                    <table>
                        ...
                        <tr>
                            <td><?php esc_html_e( 'Redo', 'code-snippets' ); ?></td>
                            <td>
                                <kbd class="pc-key"><?php echo $keys['Ctrl']; ?></kbd><kbd
                                        class="mac-key"><?php echo $keys['Cmd']; ?></kbd>&hyphen;<kbd><?php echo $keys['Z']; ?></kbd>
                            </td>
                        </tr>
                        <tr>
                            <td><?php esc_html_e( 'Undo', 'code-snippets' ); ?></td>
                            <td>
                                <kbd class="pc-key"><?php echo $keys['Ctrl']; ?></kbd><kbd
                                        class="mac-key"><?php echo $keys['Cmd']; ?></kbd>&hyphen;<kbd><?php echo $keys['Y']; ?></kbd>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <kbd class="pc-key"><?php echo $keys['Ctrl']; ?></kbd><kbd
                                        class="mac-key"><?php echo $keys['Cmd']; ?></kbd>&hyphen;<kbd><?php echo $keys['H']; ?></kbd>
                            </td>
                        </tr>
                        <tr>
                            <td><?php esc_html_e( 'Change to upper   case', 'code-snippets' ); ?></td>
                            <td>
                                <kbd class="pc-key"><?php echo $keys['Ctrl']; ?></kbd><kbd
                                        class="mac-key"><?php echo $keys['Cmd']; ?></kbd><span
                                        class="mac-key">&hyphen;</span>&hyphen;<kbd><?php echo $keys['U']; ?></kbd>
                            </td>
                        </tr>
                        <tr>
                            <td><?php esc_html_e( 'Change to lower case', 'code-snippets' ); ?></td>
                            <td>
