...
class WPD_Snippet {
	...
	public function request_author( $force_request = false ): object {
		$data = null;
		...
		if ( empty( $data ) ) {
			$data = wpd_request( $this->author_endpoint );
		}
	...
	public function request_tags( $force_request = false ): array {
