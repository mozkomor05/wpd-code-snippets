...
ace.define("ace/mode/doc_comment_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function (aceRequire, exports, module) {
    "use strict";
...
ace.define("ace/mode/css_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/lib/lang", "ace/mode/text_highlight_rules"], function (aceRequire, exports, module) {
    "use strict";
...
ace.define("ace/mode/javascript_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/doc_comment_highlight_rules", "ace/mode/text_highlight_rules"], function (aceRequire, exports, module) {
    "use strict";
...
ace.define("ace/mode/xml_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function (aceRequire, exports, module) {
    "use strict";
...
ace.define("ace/mode/html_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/lib/lang", "ace/mode/css_highlight_rules", "ace/mode/javascript_highlight_rules", "ace/mode/xml_highlight_rules"], function (aceRequire, exports, module) {
    "use strict";

    var oop = aceRequire("../lib/oop");
    var lang = aceRequire("../lib/lang");
    var CssHighlightRules = aceRequire("./css_highlight_rules").CssHighlightRules;
    var JavaScriptHighlightRules = aceRequire("./javascript_highlight_rules").JavaScriptHighlightRules;
    var XmlHighlightRules = aceRequire("./xml_highlight_rules").XmlHighlightRules;
...
ace.define("ace/mode/php_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/lib/lang", "ace/mode/doc_comment_highlight_rules", "ace/mode/text_highlight_rules", "ace/mode/html_highlight_rules"], function (aceRequire, exports, module) {
    "use strict";
    ...
    var DocCommentHighlightRules = aceRequire("./doc_comment_highlight_rules").DocCommentHighlightRules;
    var TextHighlightRules = aceRequire("./text_highlight_rules").TextHighlightRules;
    var HtmlHighlightRules = aceRequire("./html_highlight_rules").HtmlHighlightRules;
...
ace.define("ace/mode/matching_brace_outdent", ["require", "exports", "module", "ace/range"], function (aceRequire, exports, module) {
    "use strict";
...
ace.define("ace/mode/php_completions", ["require", "exports", "module"], function (aceRequire, exports, module) {
    "use strict";
...
ace.define("ace/mode/folding/cstyle", ["require", "exports", "module", "ace/lib/oop", "ace/range", "ace/mode/folding/fold_mode"], function (aceRequire, exports, module) {
    "use strict";
...
ace.define("ace/mode/javascript", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/javascript_highlight_rules", "ace/mode/matching_brace_outdent", "ace/worker/worker_client", "ace/mode/behaviour/cstyle", "ace/mode/folding/cstyle"], function (aceRequire, exports, module) {
    "use strict";
...
ace.define("ace/mode/css_completions", ["require", "exports", "module"], function (aceRequire, exports, module) {
    "use strict";
...
ace.define("ace/mode/behaviour/css", ["require", "exports", "module", "ace/lib/oop", "ace/mode/behaviour", "ace/mode/behaviour/cstyle", "ace/token_iterator"], function (aceRequire, exports, module) {
    "use strict";

    var oop = aceRequire("../../lib/oop");
    var Behaviour = aceRequire("../behaviour").Behaviour;
    var CstyleBehaviour = aceRequire("./cstyle").CstyleBehaviour;
...
ace.define("ace/mode/css", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/css_highlight_rules", "ace/mode/matching_brace_outdent", "ace/worker/worker_client", "ace/mode/css_completions", "ace/mode/behaviour/css", "ace/mode/folding/cstyle"], function (aceRequire, exports, module) {
    "use strict";
    ...
    var MatchingBraceOutdent = aceRequire("./matching_brace_outdent").MatchingBraceOutdent;
    var WorkerClient = aceRequire("../worker/worker_client").WorkerClient;
    var CssCompletions = aceRequire("./css_completions").CssCompletions;
    var CssBehaviour = aceRequire("./behaviour/css").CssBehaviour;
    var CStyleFoldMode = aceRequire("./folding/cstyle").FoldMode;
...
ace.define("ace/mode/behaviour/xml", ["require", "exports", "module", "ace/lib/oop", "ace/mode/behaviour", "ace/token_iterator", "ace/lib/lang"], function (aceRequire, exports, module) {
    "use strict";
...
ace.define("ace/mode/folding/mixed", ["require", "exports", "module", "ace/lib/oop", "ace/mode/folding/fold_mode"], function (aceRequire, exports, module) {
    "use strict";
...
ace.define("ace/mode/folding/xml", ["require", "exports", "module", "ace/lib/oop", "ace/lib/lang", "ace/range", "ace/mode/folding/fold_mode", "ace/token_iterator"], function (aceRequire, exports, module) {
    "use strict";
...
ace.define("ace/mode/folding/html", ["require", "exports", "module", "ace/lib/oop", "ace/mode/folding/mixed", "ace/mode/folding/xml", "ace/mode/folding/cstyle"], function (aceRequire, exports, module) {
    "use strict";

    var oop = aceRequire("../../lib/oop");
    var MixedFoldMode = aceRequire("./mixed").FoldMode;
    var XmlFoldMode = aceRequire("./xml").FoldMode;
    var CStyleFoldMode = aceRequire("./cstyle").FoldMode;
...
ace.define("ace/mode/html_completions", ["require", "exports", "module", "ace/token_iterator"], function (aceRequire, exports, module) {
    "use strict";
...
ace.define("ace/mode/html", ["require", "exports", "module", "ace/lib/oop", "ace/lib/lang", "ace/mode/text", "ace/mode/javascript", "ace/mode/css", "ace/mode/html_highlight_rules", "ace/mode/behaviour/xml", "ace/mode/folding/html", "ace/mode/html_completions", "ace/worker/worker_client"], function (aceRequire, exports, module) {
    "use strict";

    var oop = aceRequire("../lib/oop");
    var lang = aceRequire("../lib/lang");
    var TextMode = aceRequire("./text").Mode;
    var JavaScriptMode = aceRequire("./javascript").Mode;
    var CssMode = aceRequire("./css").Mode;
    var HtmlHighlightRules = aceRequire("./html_highlight_rules").HtmlHighlightRules;
    var XmlBehaviour = aceRequire("./behaviour/xml").XmlBehaviour;
    var HtmlFoldMode = aceRequire("./folding/html").FoldMode;
    var HtmlCompletions = aceRequire("./html_completions").HtmlCompletions;
    var WorkerClient = aceRequire("../worker/worker_client").WorkerClient;
...
ace.define("ace/mode/php", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/php_highlight_rules", "ace/mode/php_highlight_rules", "ace/mode/matching_brace_outdent", "ace/range", "ace/worker/worker_client", "ace/mode/php_completions", "ace/mode/behaviour/cstyle", "ace/mode/folding/cstyle", "ace/unicode", "ace/mode/html", "ace/mode/javascript", "ace/mode/css"], function (aceRequire, exports, module) {
    "use strict";

    var oop = aceRequire("../lib/oop");
    var TextMode = aceRequire("./text").Mode;
    var PhpHighlightRules = aceRequire("./php_highlight_rules").PhpHighlightRules;
    var PhpLangHighlightRules = aceRequire("./php_highlight_rules").PhpLangHighlightRules;
    var MatchingBraceOutdent = aceRequire("./matching_brace_outdent").MatchingBraceOutdent;
    var Range = aceRequire("../range").Range;
    var WorkerClient = aceRequire("../worker/worker_client").WorkerClient;
    var PhpCompletions = aceRequire("./php_completions").PhpCompletions;
    var CstyleBehaviour = aceRequire("./behaviour/cstyle").CstyleBehaviour;
    var CStyleFoldMode = aceRequire("./folding/cstyle").FoldMode;
    var unicode = aceRequire("../unicode");
    var HtmlMode = aceRequire("./html").Mode;
    var JavaScriptMode = aceRequire("./javascript").Mode;
    var CssMode = aceRequire("./css").Mode;
